...
func (r *TodoListPostgres) Create(userId int, list maxHTTP.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]maxHTTP.TodoList, error) {
	var lists []maxHTTP.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (maxHTTP.TodoList, error) {
	var list maxHTTP.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input maxHTTP.UpdateListInput) error {
